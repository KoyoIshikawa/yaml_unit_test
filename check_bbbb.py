...
taraget = [ 
    {'file': '../yaml_list/bbbb/aaa_1.yaml',
      'parameters': [
        {'elements': ['DistributionList', 'Items', 0, 'BBB'], 'expected_value': ''},
    ...
    {'file': '../yaml_list/bbbb/aaa_2.yaml',
      'parameters': [
        {'elements': ['DistributionList'], 'expected_value': ''},
        {'elements': ['Items', 0, 'BBB'], 'expected_value': ''},
        {'elements': ['Aliases', 'Quantity'], 'expected_value': ''},
        {'elements': ['CacheBehaviors', 'Items', 0, 'AllowedMethods', 'CachedMethods', 'Items', 0], 'expected_value': ''},
        {'elements': ['CacheBehaviors', 'Items', 0, 'AllowedMethods', 'CachedMethods', 'Items', 1], 'expected_value': ''},
        {'elements': ['CacheBehaviors', 'Items', 0, 'AllowedMethods', 'CachedMethods', 'Quantity'], 'expected_value': ''},
        {'elements': ['CacheBehaviors', 'Items', 0, 'AllowedMethods', 'Items', 0], 'expected_value': ''},
        {'elements': ['CacheBehaviors', 'Items', 0, 'AllowedMethods', 'Items', 1], 'expected_value': ''},
        {'elements': ['CacheBehaviors', 'Items', 0, 'AllowedMethods', 'Quantity'], 'expected_value': ''},
        {'elements': ['CacheBehaviors', 'Items', 0, 'CachePolicyId'], 'expected_value': ''},
        {'elements': ['CacheBehaviors', 'Items', 0, 'Compress'], 'expected_value': ''},
        {'elements': ['CacheBehaviors', 'Items', 0, 'FieldLevelEncryptionId'], 'expected_value': ''},
        {'elements': ['CacheBehaviors', 'Items', 0, 'FunctionAssociations', 'Quantity'], 'expected_value': ''},
        {'elements': ['CacheBehaviors', 'Items', 0, 'LambdaFunctionAssociations', 'Quantity'], 'expected_value': ''},
        {'elements': ['CacheBehaviors', 'Items', 0, 'PathPattern'], 'expected_value': ''},
        {'elements': ['CacheBehaviors', 'Items', 0, 'SmoothStreaming'], 'expected_value': ''},
        {'elements': ['CacheBehaviors', 'Items', 0, 'TargetOriginId'], 'expected_value': ''},
        {'elements': ['CacheBehaviors', 'Items', 0, 'TrustedKeyGroups', 'Enabled'], 'expected_value': ''},
        {'elements': ['CacheBehaviors', 'Items', 0, 'TrustedKeyGroups', 'Quantity'], 'expected_value': ''},
        {'elements': ['CacheBehaviors', 'Items', 0, 'TrustedSigners', 'Enabled'], 'expected_value': ''},
        {'elements': ['CacheBehaviors', 'Items', 0, 'TrustedSigners', 'Quantity'], 'expected_value': ''},
        {'elements': ['CacheBehaviors', 'Items', 0, 'ViewerProtocolPolicy'], 'expected_value': ''},
        {'elements': ['CacheBehaviors', 'Quantity'], 'expected_value': ''},
        {'elements': ['Comment'], 'expected_value': ''},
        {'elements': ['CustomErrorResponses', 'Quantity'], 'expected_value': ''},
        {'elements': ['DefaultCacheBehavior', 'AllowedMethods', 'CachedMethods', 'Items', 0], 'expected_value': ''},
        {'elements': ['DefaultCacheBehavior', 'AllowedMethods', 'CachedMethods', 'Items', 1], 'expected_value': ''},
        {'elements': ['DefaultCacheBehavior', 'AllowedMethods', 'CachedMethods', 'Quantity'], 'expected_value': ''},
        {'elements': ['DefaultCacheBehavior', 'AllowedMethods', 'Items', 0], 'expected_value': ''},
        {'elements': ['DefaultCacheBehavior', 'AllowedMethods', 'Items', 1], 'expected_value': ''},
        {'elements': ['DefaultCacheBehavior', 'AllowedMethods', 'Quantity'], 'expected_value': ''},
        {'elements': ['DefaultCacheBehavior', 'CachePolicyId'], 'expected_value': ''},
        {'elements': ['DefaultCacheBehavior', 'Compress'], 'expected_value': ''},
        {'elements': ['DefaultCacheBehavior', 'FieldLevelEncryptionId'], 'expected_value': ''},
        {'elements': ['DefaultCacheBehavior', 'FunctionAssociations', 'Quantity'], 'expected_value': ''},
        {'elements': ['DefaultCacheBehavior', 'LambdaFunctionAssociations', 'Quantity'], 'expected_value': ''},
        {'elements': ['DefaultCacheBehavior', 'SmoothStreaming'], 'expected_value': ''},
        {'elements': ['DefaultCacheBehavior', 'TargetOriginId'], 'expected_value': ''},
        {'elements': ['DefaultCacheBehavior', 'TrustedKeyGroups', 'Enabled'], 'expected_value': ''},
        {'elements': ['DefaultCacheBehavior', 'TrustedKeyGroups', 'Quantity'], 'expected_value': ''},
        {'elements': ['DefaultCacheBehavior', 'TrustedSigners', 'Enabled'], 'expected_value': ''},
        {'elements': ['DefaultCacheBehavior', 'TrustedSigners', 'Quantity'], 'expected_value': ''},
        {'elements': ['DefaultCacheBehavior', 'ViewerProtocolPolicy'], 'expected_value': ''},
        {'elements': ['DomainName'], 'expected_value': ''},
        {'elements': ['Enabled'], 'expected_value': ''},
        {'elements': ['HttpVersion'], 'expected_value': ''},
        {'elements': ['Id'], 'expected_value': ''},
        {'elements': ['IsIPV6Enabled'], 'expected_value': ''},
        {'elements': ['LastModifiedTime'], 'expected_value': ''},
        {'elements': ['OriginGroups', 'Quantity'], 'expected_value': ''},
        {'elements': ['Origins', 'Items', 0, 'ConnectionAttempts'], 'expected_value': ''},
        {'elements': ['Origins', 'Items', 0, 'ConnectionTimeout'], 'expected_value': ''},
        {'elements': ['Origins', 'Items', 0, 'CustomHeaders', 'Items', 0, 'HeaderName'], 'expected_value': ''},
        {'elements': ['Origins', 'Items', 0, 'CustomHeaders', 'Items', 0, 'HeaderValue'], 'expected_value': ''},
        {'elements': ['Origins', 'Items', 0, 'CustomHeaders', 'Quantity'], 'expected_value': ''},
        {'elements': ['Origins', 'Items', 0, 'CustomOriginConfig', 'HTTPPort'], 'expected_value': ''},
        {'elements': ['Origins', 'Items', 0, 'CustomOriginConfig', 'HTTPSPort'], 'expected_value': ''},
        {'elements': ['Origins', 'Items', 0, 'CustomOriginConfig', 'OriginKeepaliveTimeout'], 'expected_value': ''},
        {'elements': ['Origins', 'Items', 0, 'CustomOriginConfig', 'OriginProtocolPolicy'], 'expected_value': ''},
        {'elements': ['Origins', 'Items', 0, 'CustomOriginConfig', 'OriginReadTimeout'], 'expected_value': ''},
        {'elements': ['Origins', 'Items', 0, 'CustomOriginConfig', 'OriginSslProtocols', 'Items', 0], 'expected_value': ''},
        {'elements': ['Origins', 'Items', 0, 'CustomOriginConfig', 'OriginSslProtocols', 'Quantity'], 'expected_value': ''},
        {'elements': ['Origins', 'Items', 0, 'DomainName'], 'expected_value': ''},
        {'elements': ['Origins', 'Items', 0, 'Id'], 'expected_value': ''},
        {'elements': ['Origins', 'Items', 0, 'OriginAccessControlId'], 'expected_value': ''},
        {'elements': ['Origins', 'Items', 0, 'OriginPath'], 'expected_value': ''},
        {'elements': ['Origins', 'Items', 0, 'OriginShield', 'Enabled'], 'expected_value': ''},
        {'elements': ['Origins', 'Quantity'], 'expected_value': ''},
        {'elements': ['PriceClass'], 'expected_value': ''},
        {'elements': ['Restrictions', 'GeoRestriction', 'Quantity'], 'expected_value': ''},
        {'elements': ['Restrictions', 'GeoRestriction', 'RestrictionType'], 'expected_value': ''},
        {'elements': ['Staging'], 'expected_value': ''},
        {'elements': ['Status'], 'expected_value': ''},
        {'elements': ['ViewerCertificate', 'CertificateSource'], 'expected_value': ''},
        {'elements': ['ViewerCertificate', 'CloudFrontDefaultCertificate'], 'expected_value': ''},
        {'elements': ['ViewerCertificate', 'MinimumProtocolVersion'], 'expected_value': ''},
        {'elements': ['ViewerCertificate', 'SSLSupportMethod'], 'expected_value': ''},
        {'elements': ['WebACLId'], 'expected_value': ''},
     ]
    },
]